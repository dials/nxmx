...
class NXdetector(H5Mapping):
    ...
    def bit_depth_image(self) -> int | None:
        """Bit depth of generated images.

        Note this is currently a non-standard item that is included in NeXus
        files generated by DECTRIS. See
        https://www.dectris.com/support/downloads/header-docs/nexus/

        See also: https://github.com/nexusformat/definitions/issues/1258
        """
